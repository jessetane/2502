...
def messageMethod(name, argnames):
    ...
    """
    def inner(self, *args):
        params = dict(list(zip(argnames, args)))
...
MetaReceiverType = ReceiverType('MetaReceiverType', (object, ), {})

class Receiver(MetaReceiverType):
    ...
    def registerAll(self, listener):
        ...
        @return True if associated with one or more handler; otherwise False
        """
        return self.register(listener, *list(self.types.values()))
    ...
    def unregisterAll(self, listener):
        ...
        @return True if disassociated with one or more handler; otherwise False
        """
        return self.unregister(listener, *list(self.types.values()))
