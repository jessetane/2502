...
# Exception syntax modified from "except (Exception, ), ex:" to "except (Exception, ) as ex:"
# Commented out overloaded send function that handles longs (Py3k does not have a long type) - do we need this?
#
