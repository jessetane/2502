...
# Maxint to maxsize, there is no "long" type in Py3k
# Java compatible Integer class's static method "parseLong" modified
##
...
class Integer(int):
    ...
    def parseLong(text):
        ...
        """
        # modified for Py3k support
        try: return int(text or 0)
        except: return int(text or 0)
